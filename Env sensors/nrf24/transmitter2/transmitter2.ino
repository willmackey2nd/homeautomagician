...
#define WLEVELPIN A2 // Water level sensor analog input
#define TMPSDA A4    // SDA
#define TMPSCL A5    // SCL
#define TMPPWRPIN 8  // Temperature sensor power supply pin
#define SEALEVELPRESSURE_HPA (1013.25)

// NF24
#define NF24_PWR_PIN 6
#define NF24_CE_PIN A1
#define NF24_CSN_PIN A0
// MOSI 11
// MISO 12
// SCK  13
...
void setup()
{
  ...
  PRINTL("");
  PRINT("sensor ID ");
  PRINTL(sensorpacket1.id);

  // InitNRF24();
  PRINT("configured packet size: ");
